          ...
          <>
            ...
            <footer className={`py-6 text-center text-xs font-mono ${darkMode ? 'text-slate-500 border-slate-800/80 bg-slate-950/40' : 'text-slate-400 border-slate-200'} border-t`}>
              <div className="max-w-7xl mx-auto px-4 flex flex-col sm:flex-row items-center justify-between gap-2">
                <span>© {new Date().getFullYear()} Open-Forensics Shift Simulator • DFIR Lab Training</span>
                <span className="text-slate-600">Expertise forensique et investigation numérique</span>
              </div>
            </footer>
          </>
        )}
